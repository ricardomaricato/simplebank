...
type SimpleBankClient interface {
	...
	UpdateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UpdateUserResponse, error)
...
func (c *simpleBankClient) UpdateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UpdateUserResponse, error) {
...
type SimpleBankServer interface {
	...
	UpdateUser(context.Context, *CreateUserRequest) (*UpdateUserResponse, error)
...
func (UnimplementedSimpleBankServer) UpdateUser(context.Context, *CreateUserRequest) (*UpdateUserResponse, error) {
